...
export default function Footer() {
  return (
    <footer className="sectionPadded column gapLarge bg1To2">
      <div>
        <p className="textXSmall textSlightTransparent row centerColumn gapXSmall centerRow">
          <span className="material-symbols-outlined">info</span>
          As an Amazon Associate I earn from qualifying purchases.
        </p>
      </div>
      <div className="rowCollapsible centerRow spaceBetween gapLarge">
