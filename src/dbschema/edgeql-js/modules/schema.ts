...
export type $ObjectTypeλShape = $.typeutil.flatten<$SourceλShape & Omit<$ConsistencySubjectλShape, "<subject"> & $InheritingObjectλShape & Omit<$TypeλShape, "<target"> & $AnnotationSubjectλShape & {
  ...
  "<__type__[is Author]": $.LinkDesc<_default.$Author, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Article]": $.LinkDesc<_default.$Article, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Laptop]": $.LinkDesc<_default.$Laptop, $.Cardinality.Many, {}, false, false,  false, false>;
